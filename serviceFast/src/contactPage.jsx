...
const ContactPage = () => {
  return (
    <section className="relative min-h-screen flex items-center px-4 sm:px-6 py-16 sm:py-32 overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
        ...
        <div className="text-white">
          ...
          <div className="mt-6 sm:mt-10 grid grid-cols-2 gap-3 sm:gap-4 max-w-md">
            <div className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4">
              <p className="text-xs sm:text-sm text-gray-400">Cobertura</p>
              <p className="text-base sm:text-lg font-semibold text-white">Metropolitana</p>
            </div>

            <div className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4">
              <p className="text-xs sm:text-sm text-gray-400">Tiempo</p>
              <p className="text-base sm:text-lg font-semibold text-white">Entrega rápida</p>
            </div>

            <div className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4">
              <p className="text-xs sm:text-sm text-gray-400">Servicio</p>
              <p className="text-base sm:text-lg font-semibold text-white">Profesional</p>
            </div>

            <div className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4">
              <p className="text-xs sm:text-sm text-gray-400">Soporte</p>
              <p className="text-base sm:text-lg font-semibold text-white">Directo</p>
            </div>
          </div>
        </div>
